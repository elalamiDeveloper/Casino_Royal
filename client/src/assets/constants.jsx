...
const navBarList = [
  {
    ...
    label: "Poker",
    icon: (
      <GiPokerHand className="navbar-icon" />
    ),
  },
  {
    id: uuidv4(),
    ...
    label: "Roulette",
    icon: (
      <LuTable className="navbar-icon" />
    ),
  },
  {
    id: uuidv4(),
    path: "/games/blackjack/list",
    label: "Blackjack",
    icon: (
      <PiPokerChipBold className="navbar-icon" />
    ),
  },
  {
    id: uuidv4(),
    ...
    label: "Cadeau",
    icon: (
      <BiSolidGift className="navbar-icon" />
    ),
  },
  {
    id: uuidv4(),
